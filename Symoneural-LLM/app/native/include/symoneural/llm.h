...
/* space-separated: "text streaming cancellation tokenize gpu:<backend>|cpu|backend:none";
 * gpu:<backend> only when a GPU device is enumerable in this process (1.1.0); the ggml
 * backends are dlopen'ed modules found next to this library (<libdir>/ggml), and
 * backend:none means none loaded (1.1.1) */
